...
from nets.lama.training.modules.ffc import FFCResNetGenerator
from nets.lama.training.modules.pix2pixhd import GlobalGenerator, MultiDilatedGlobalGenerator, \
